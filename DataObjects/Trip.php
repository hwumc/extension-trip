...
class Trip extends DataObject
{
    ...
    function getShowLeaveFrom()
    {
        return $this->showleavefrom;
    }

    function setShowLeaveFrom( $showLeaveFrom )
    {
        $this->showleavefrom = $showLeaveFrom;
    }
    ...
    public function save()
    {
        ...
        if($this->isNew)
        { // insert
            $statement = $gDatabase->prepare("INSERT INTO `trip` (startdate, enddate, semester, week, year, location, description, price, spaces, status, signupclose, hasmeal, driverplaces, signupopen, showleavefrom) VALUES (:startdate, :enddate, :semester, :week, :year, :location, :description, :price, :spaces, :status, :signupclose, :hasmeal, :driverplaces, :signupopen, :showleavefrom);");
            ...
            $statement->bindParam(":showleavefrom", $this->showleavefrom);
        ...
        { // update
            $statement = $gDatabase->prepare("UPDATE `" . strtolower( get_called_class() ) . "` SET startdate = :startdate, enddate = :enddate, semester = :semester, year = :year, week = :week, location = :location, description = :description, price = :price, spaces = :spaces, status = :status, signupclose = :signupclose, hasmeal = :hasmeal, driverplaces = :driverplaces, signupopen = :signupopen, showleavefrom = :showleavefrom WHERE id = :id LIMIT 1;");
